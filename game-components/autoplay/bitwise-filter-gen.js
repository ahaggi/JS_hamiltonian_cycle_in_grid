...
import { BITS_PER_SECTION, msb, clear_bit, } from "./bitwise-help-functions"
...
const get_left_shifted_filter = (this_path_mask, other_path_mask, section_index) => {
    /**
...
const get_right_shifted_filter = (this_path_mask, other_path_mask, section_index) => {
    /**
...
const calc_pivots_other_to_this_upper_wall = (section_index, _this, _other) => {
    ...
    let filter_upper_wall = get_left_shifted_filter(_this.path_mask, _other.path_mask, section_index)
...
const calc_pivots_other_to_this_left_T_wall = (section_index, _this, _other) => {
    ...
    let found = false
    let option = null
    let filter_T_left_wall = get_left_shifted_filter(_this.path_T_mask, _other.path_T_mask, section_index)
...
const calc_pivots_other_to_this_lower_wall = (section_index, _this, _other) => {
    // Right shifting the "this .path_mask[0]"
    // 15  14  13  12  11  10  09  08  07  06  05  04  03  02  01  00 <-- OTHER IS CYCLIC
    // 23  22  21  20  19  18  17  16  15  14  13  12  11  10  09  08 <-- this.subgraph been right-shifted ignoring first n bits in this subgraph   
    ...
    let filter_lower_wall = get_right_shifted_filter(_this.path_mask, _other.path_mask, section_index)
...
const calc_pivots_other_to_this_rigth_T_wall = (section_index, _this, _other) => {
    // right shifting the "this .path_T_mask[0]"
    // 57  49  41  33  25  17  09  01  56  48  40  32  24  16  08  00 <-- OTHER IS CYCLIC
    ...
    let found = false
    let option = null
    let filter_T_right_wall = get_right_shifted_filter(_this.path_T_mask, _other.path_T_mask, section_index)
